...
try {
  const checks = [
    ...
    ['/legacy-wiki/es/', 'Wiki de Legacy'],
    ['/legacy-wiki/es/systems/classes/', 'Catálogo de clases de Legacy'],
    ['/legacy-wiki/fr/', 'Wiki Legacy'],
    ['/legacy-wiki/fr/systems/classes/', 'Catalogue des classes de Legacy'],
    ['/legacy-wiki/ru/', 'Вики Legacy'],
    ['/legacy-wiki/ru/systems/classes/', 'Каталог классов Legacy'],
    ...
    ['/games/legacy/wiki/es/', 'Wiki de Legacy'],
    ['/games/legacy/wiki/fr/', 'Wiki Legacy'],
    ['/games/legacy/wiki/ru/', 'Вики Legacy'],
    ...
    ['/__cloudflare/legacy/es/', 'Wiki de Legacy'],
    ['/__cloudflare/legacy/fr/', 'Wiki Legacy'],
    ['/__cloudflare/legacy/ru/', 'Вики Legacy'],
